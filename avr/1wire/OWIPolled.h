...
#ifndef __XLIB_AVR_OWI_POLLED_H_
#define __XLIB_AVR_OWI_POLLED_H_

#include "xlib/avr/1wire/common_files/OWIdefs.h"
#include "xlib/avr/1wire/common_files/OWIDeviceSpecific.h"
...
#if defined(OWI_SOFTWARE_DRIVER) | defined(OWI_UART_DRIVER)
//#elif defined(OWI_SOFTWARE_DRIVER) & defined(OWI_UART_DRIVER)
//#error "For OWI lib defined OWI_SOFTWARE_DRIVER and OWI_UART_DRIVER! Choose only one macro!"
#else
#error "For OWI lib define OWI_SOFTWARE_DRIVER or OWI_UART_DRIVER"
#endif
